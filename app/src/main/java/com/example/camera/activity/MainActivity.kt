...
//    private lateinit var textureView: AutoFitTextureView
    ...
    override fun onImageSaveSuccessful(imagePath: String?) {
        imagePath?.let {
            ImagePreviewActivity.launch(this,it)
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!listPermissionNeeded.isEmpty()) {
                ActivityCompat.requestPermissions(
                    this@MainActivity,
                    listPermissionNeeded.toTypedArray(), REQUEST_CAMERA_PERMISSION
                )
                return
            }
        }
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            ...
            ConfirmationDialog().onErrorDialog(this).show()
        }
    ...
    private fun openCamera(width: Int, height: Int) {
        val permissionList = arrayOf(ContextCompat.checkSelfPermission(this,Manifest.permission.CAMERA),
            ContextCompat.checkSelfPermission(this,Manifest.permission.WRITE_EXTERNAL_STORAGE),
            ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STORAGE))

        for (i in 0 until permissionList.size) {
            if (permissionList[i] != PackageManager.PERMISSION_GRANTED) {
                requestCameraPermission()
                return
            }
        }
